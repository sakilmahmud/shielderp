                            ...
                            <form action="<?php echo $action; ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="mt-1 d-flex justify-content-between">
                                        ...
                                        <a href="javascript:void(0)" class="text-sm add_client">Add Client</a>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="mt-1 d-flex justify-content-between">
                                        ...
                                        <a href="javascript:void(0)" class="text-sm add_doer">Add Doer</a>
                                    </div>
...
<!-- Add Doer Modal -->
<div class="modal fade" id="addDoerModal" tabindex="-1" role="dialog" aria-labelledby="addDoerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
