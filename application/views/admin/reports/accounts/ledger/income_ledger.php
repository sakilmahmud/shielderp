<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-rupee-sign"></i> Income Ledger</h1>
                </div>
            ...
            <form method="get" class="mb-3">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right mt-4">
                        <a target="_blank" href="<?= base_url("admin/reports/accounts/export_income_ledger/pdf?from=$from&to=$to&head_id=$head_id") ?>" class="btn btn-info btn-sm mt-2"><i class="fas fa-file-pdf"></i> Export PDF</a>
                        <a target="_blank" href="<?= base_url("admin/reports/accounts/export_income_ledger/excel?from=$from&to=$to&head_id=$head_id") ?>" class="btn btn-success btn-sm mt-2"><i class="fas fa-file-excel"></i> Export Excel</a>
                    </div>
                </div>
            </form>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            // Step 1: Group rows by trans_date + head_title
                            foreach ($ledger as $row) {
                                ...
                                $particular = ($row->income_title ?? $row->expense_title) . ' - ' . $row->invoice_no;
