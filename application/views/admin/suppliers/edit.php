        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo base_url('admin/suppliers/edit/' . $supplier['id']); ?>" method="post">
                                <div class="form-group mb-3">
                                    <label for="supplier_name">Supplier Name</label>
                                    <input type="text" class="form-control" id="supplier_name" name="supplier_name" value="<?php echo set_value('supplier_name', $supplier['supplier_name']); ?>" required>
                                    <?php echo form_error('supplier_name'); ?>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="phone">Phone</label>
                                    <input type="text" class="form-control" id="phone" name="phone" value="<?php echo set_value('phone', $supplier['phone']); ?>" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="address" name="address" required><?php echo set_value('address', $supplier['address']); ?></textarea>
